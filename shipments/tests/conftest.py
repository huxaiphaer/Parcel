...
def valid_shipment_with_articles(db):
    ...
    Article.objects.create(
        shipment=shipment, name="Laptop", quantity=1, price=800, sku="LP123"
    )
    Article.objects.create(
        shipment=shipment, name="Mouse", quantity=1, price=25, sku="MO456"
    )
...
def valid_shipment_with_articles(db):
    ...
    Article.objects.create(
        shipment=shipment, name="Mouse", quantity=1, price="25.00", sku="MO456"
    )
    return shipment
